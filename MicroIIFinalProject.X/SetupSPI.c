...
UINT16 SetupSPI(void)
{
    OpenSPI1(ENABLE_SCK_PIN
            ...
            FIFO_BUFFER_DISABLE &       //signle word transmission - fifo not needed
            ...
            SEC_PRESCAL_1_1 &           //
            PRI_PRESCAL_64_1            //slow transmission down at first
            ,
            SPI_ENABLE &                //enable the module
            SPI_IDLE_CON                //continue in idle mode
            );

    ConfigIntSPI1(SPI_INT_DIS);         //disable interrupts (assuming these are interrupts generated by SDI, which I am not using)
